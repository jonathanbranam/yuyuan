...
ActiveRecord::Schema.define(:version => 20090907150730) do
  ...
  create_table "review_list_order_items", :force => true do |t|
  ...
  create_table "review_list_orders", :force => true do |t|
